...
- Durbin-Watson & Residual Analysis confirmed LR assumptions met. Adj. R-squared: 0.833. R2 score is almost similar in test and train dataset. So no possible overfitting is identified.
